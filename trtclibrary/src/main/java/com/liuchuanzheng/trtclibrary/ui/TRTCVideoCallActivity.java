...
import com.liuchuanzheng.trtclibrary.ui.videolayout.TRTCVideoLayout;
import com.liuchuanzheng.trtclibrary.ui.videolayout.TRTCVideoLayoutManager;
...
public class TRTCVideoCallActivity extends AppCompatActivity {
    ...
    private void initListener() {
        ...
        ll_switch_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mITRTCVideoCall.switchCamera(bFrontCamera);
                ll_switch_camera.setActivated(bFrontCamera);
                ToastUtils.showLong(bFrontCamera ? "开启前置摄像头" : "开启后置摄像头");
            }
        });
        mMuteImg.setActivated(isMuteMic);
        mHandsfreeImg.setActivated(isHandsFree);
    ...
    private void initView() {
        ...
        ll_switch_camera = (LinearLayout) findViewById(R.id.ll_switch_camera);
    }
    ...
    public void showWaitingResponseView() {
        ...
        tv_roomId.setText("房间号:"+((TRTCVideoCallImpl)mITRTCVideoCall).mCurRoomID);
        //摄像头翻转按钮
                ...
                public void run() {
                    ...
                    if (mTimeTv != null) {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
//                                mTimeTv.setText(getShowTime(mTimeCount)+"\n房间号:"+((TRTCVideoCallImpl)mITRTCVideoCall).mCurRoomID);
                                mTimeTv.setText(getShowTime(mTimeCount));
                            }
                        });
                    }
